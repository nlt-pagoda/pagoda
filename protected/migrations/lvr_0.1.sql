...
CREATE SCHEMA IF NOT EXISTS `pagoda` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `pagoda` ;

-- -----------------------------------------------------
-- Table `pagoda`.`Roles`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Roles` (
...
-- Table `pagoda`.`User`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`User` (
...
-- -----------------------------------------------------
-- Table `pagoda`.`Users_has_Roles`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Users_has_Roles` (
  ...
  CONSTRAINT `fk_Users_has_Roles_Users`
    FOREIGN KEY (`UsersID` )
    REFERENCES `pagoda`.`User` (`UserID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Users_has_Roles_Roles1`
    FOREIGN KEY (`RolesID` )
    REFERENCES `pagoda`.`Roles` (`RolesID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `pagoda`.`Course`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Course` (
...
-- -----------------------------------------------------
-- Table `pagoda`.`Assignment`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Assignment` (
  ...
  CONSTRAINT `fk_Assignment_Course1`
    ...
    REFERENCES `pagoda`.`Course` (`CourseID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pagoda`.`Document`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Document` (
  ...
  CONSTRAINT `fk_Document_Assignment1`
    ...
    REFERENCES `pagoda`.`Assignment` (`AssignmentID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `pagoda`.`Course_has_Students`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Course_has_Students` (
  `CourseID` INT UNSIGNED NOT NULL ,
  `StudentID` INT UNSIGNED NOT NULL ,
...
-- -----------------------------------------------------
-- Table `pagoda`.`Message`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Message` (
...
-- Table `pagoda`.`Rubric`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Rubric` (
...
-- -----------------------------------------------------
-- Table `pagoda`.`Assignment_has_Rubric`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Assignment_has_Rubric` (
  `AssignmentID` INT UNSIGNED NOT NULL ,
  ...
  CONSTRAINT `fk_Assignment_has_Rubric_Rubric1`
    ...
    REFERENCES `pagoda`.`Rubric` (`RubricID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pagoda`.`Criteria`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Criteria` (
...
-- Table `pagoda`.`Score`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Score` (
  ...
  CONSTRAINT `fk_Score_Criteria1`
    ...
    REFERENCES `pagoda`.`Criteria` (`CriteriaID` , `RubricID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pagoda`.`Preferences`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Preferences` (
...
-- -----------------------------------------------------
-- Table `pagoda`.`Profile`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pagoda`.`Profile` (
